...
(gain 2, raw cap .12 rad, tau .10 s) onto the same fixed q2 goal, and replaces
...
class GraspProbePolicy:
    ...
    def __init__(self, schema, observation_joint_names, defaults, dt=.02, *,
        ...
        self.still_samples = int(round(LIFT_STILL_WINDOW_S/self.dt))+1
