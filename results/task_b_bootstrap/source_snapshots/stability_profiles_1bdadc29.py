    ...
    def _annotate(self, out, *, snapshot=None, settling: bool = False, disabled: bool = False,
        ...
        record = {
            ...
            "absolute": {
                ...
                "tilt_deg": (None if abs_tilt is None or not np.isfinite(abs_tilt)
                             else float(np.degrees(np.arcsin(min(1.0, abs_tilt))))),
        ...
        spec["neutral_reference"] = {
            ...
            "absolute_envelope": {
                ...
                "action": "wheel request scaled by a ramp between deadband and abort; on abort or "
                          ...
                          "zero wheel request, which triggers its native abort and immediate stop",
